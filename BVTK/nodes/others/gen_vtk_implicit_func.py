...
add_node(BVTK_NT_Superquadric, cat)
...
add_node(BVTK_NT_ImplicitSum, cat)
...
add_node(BVTK_NT_ImplicitPolyDataDistance, cat)
...
add_node(BVTK_NT_ImplicitSelectionLoop, cat)
...
add_node(BVTK_NT_ImplicitDataSet, cat)
...
add_node(BVTK_NT_ImplicitBoolean, cat)
...
add_node(BVTK_NT_ImplicitWindowFunction, cat)
...
add_node(BVTK_NT_ImplicitHalo, cat)
...
add_node(BVTK_NT_ImplicitVolume, cat)
...
add_node(BVTK_NT_PlanesIntersection, cat)
...
add_node(BVTK_NT_PolyPlane, cat)
...
add_node(BVTK_NT_PerlinNoise, cat)
