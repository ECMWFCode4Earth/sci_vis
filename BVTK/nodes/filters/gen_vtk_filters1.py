...
add_node(BVTK_NT_ForceTime, cat)
...
add_node(BVTK_NT_LinkEdgels, cat)
...
add_node(BVTK_NT_SimpleBondPerceiver, cat)
...
add_node(BVTK_NT_CountVertices, cat)
...
add_node(BVTK_NT_QuadRotationalExtrusionFilter, cat)
...
add_node(BVTK_NT_DataSetAlgorithm, cat)
...
add_node(BVTK_NT_CountFaces, cat)
...
add_node(BVTK_NT_PassArrays, cat)
...
add_node(BVTK_NT_ImageShrink3D, cat)
...
add_node(BVTK_NT_AppendCompositeDataLeaves, cat)
...
add_node(BVTK_NT_ExtractDataOverTime, cat)
...
add_node(BVTK_NT_ImageFourierCenter, cat)
...
add_node(BVTK_NT_VectorNorm, cat)
...
add_node(BVTK_NT_PYoungsMaterialInterface, cat)
...
add_node(BVTK_NT_ImageAppend, cat)
...
class BVTK_NT_KdTreeSelector(Node, BVTK_Node):
    ...
    def m_connections(self):
        return ['Input'], ['Output'], ['KdTree'], ['Self']
    
    def methods(self):
        return []


add_node(BVTK_NT_KdTreeSelector, cat)
...
add_node(BVTK_NT_MatricizeArray, cat)
...
add_node(BVTK_NT_PResampleFilter, cat)
...
add_node(BVTK_NT_OverlappingAMRAlgorithm, cat)
...
add_node(BVTK_NT_CompositeDataSetAlgorithm, cat)
...
add_node(BVTK_NT_PiecewiseFunctionAlgorithm, cat)
...
add_node(BVTK_NT_ProcessIdScalars, cat)
...
add_node(BVTK_NT_RuledSurfaceFilter, cat)
...
add_node(BVTK_NT_ImageExtractComponents, cat)
...
add_node(BVTK_NT_MoleculeAlgorithm, cat)
...
add_node(BVTK_NT_PolyDataStreamer, cat)
...
add_node(BVTK_NT_ImageSlab, cat)
...
add_node(BVTK_NT_ImageGaussianSmooth, cat)
...
add_node(BVTK_NT_TemporalDataSetCache, cat)
...
add_node(BVTK_NT_UnstructuredGridBaseAlgorithm, cat)
...
add_node(BVTK_NT_ImageSobel3D, cat)
...
add_node(BVTK_NT_AMRSliceFilter, cat)
...
add_node(BVTK_NT_DataSetRegionSurfaceFilter, cat)
...
add_node(BVTK_NT_ProteinRibbonFilter, cat)
...
add_node(BVTK_NT_MoleculeToBondStickFilter, cat)
...
add_node(BVTK_NT_MaskPoints, cat)
...
add_node(BVTK_NT_UnstructuredGridAlgorithm, cat)
...
add_node(BVTK_NT_FieldDataToAttributeDataFilter, cat)
...
add_node(BVTK_NT_UniformGridPartitioner, cat)
...
add_node(BVTK_NT_FlyingEdges2D, cat)
...
add_node(BVTK_NT_ImageLogarithmicScale, cat)
...
add_node(BVTK_NT_TransmitStructuredGridPiece, cat)
...
class BVTK_NT_HyperTreeGridAxisClip(Node, BVTK_Node):
    ...
    def m_connections(self):
        return ['Input'], ['Output'], ['Quadric'], ['Self']
    
    def methods(self):
        return []


add_node(BVTK_NT_HyperTreeGridAxisClip, cat)
...
add_node(BVTK_NT_DensifyPolyData, cat)
...
add_node(BVTK_NT_PolyDataPointSampler, cat)
...
add_node(BVTK_NT_ImageDataGeometryFilter, cat)
...
class BVTK_NT_PointSetToLabelHierarchy(Node, BVTK_Node):
    ...
    def m_connections(self):
        return ['Input'], ['Output'], ['TextProperty'], ['Self']
    
    def methods(self):
        return []


add_node(BVTK_NT_PointSetToLabelHierarchy, cat)
...
add_node(BVTK_NT_ImageDataToPointSet, cat)
...
add_node(BVTK_NT_ShepardMethod, cat)
...
add_node(BVTK_NT_MultiBlockMergeFilter, cat)
...
add_node(BVTK_NT_CompositeDataGeometryFilter, cat)
...
add_node(BVTK_NT_ImageLaplacian, cat)
...
add_node(BVTK_NT_AMRToMultiBlockFilter, cat)
...
add_node(BVTK_NT_PMaskPoints, cat)
...
add_node(BVTK_NT_UniformGridAMRAlgorithm, cat)
...
add_node(BVTK_NT_HierarchicalDataExtractLevel, cat)
...
add_node(BVTK_NT_MergeFields, cat)
...
add_node(BVTK_NT_ArrayCalculator, cat)
...
add_node(BVTK_NT_AdaptiveSubdivisionFilter, cat)
...
add_node(BVTK_NT_ExtractPiece, cat)
...
add_node(BVTK_NT_StructuredGridAppend, cat)
...
add_node(BVTK_NT_ExtractTensorComponents, cat)
...
add_node(BVTK_NT_QuadraturePointInterpolator, cat)
...
add_node(BVTK_NT_WarpVector, cat)
...
class BVTK_NT_ClipClosedSurface(Node, BVTK_Node):
    ...
    def m_connections(self):
        return ['Input'], ['Output'], ['ClippingPlanes'], ['Self']
    
    def methods(self):
        return []


add_node(BVTK_NT_ClipClosedSurface, cat)
...
add_node(BVTK_NT_ImageAnisotropicDiffusion2D, cat)
...
add_node(BVTK_NT_ImageIdealLowPass, cat)
...
add_node(BVTK_NT_CellDerivatives, cat)
...
add_node(BVTK_NT_RectilinearGridClip, cat)
...
add_node(BVTK_NT_PointOccupancyFilter, cat)
...
class BVTK_NT_ExtractCTHPart(Node, BVTK_Node):
    ...
    def m_connections(self):
        return ['Input'], ['Output'], ['ClipPlane'], ['Self']
    
    def methods(self):
        return []


add_node(BVTK_NT_ExtractCTHPart, cat)
...
add_node(BVTK_NT_ImageToStructuredGrid, cat)
...
add_node(BVTK_NT_ExtractUserDefinedPiece, cat)
...
add_node(BVTK_NT_HierarchicalDataLevelFilter, cat)
...
add_node(BVTK_NT_PolyDataNormals, cat)
...
add_node(BVTK_NT_RandomAttributeGenerator, cat)
...
add_node(BVTK_NT_MeshQuality, cat)
...
add_node(BVTK_NT_ImageDivergence, cat)
...
class BVTK_NT_PolyDataSilhouette(Node, BVTK_Node):
    ...
    def m_connections(self):
        return ['Input'], ['Output'], ['Prop3D'], ['Self']
    
    def methods(self):
        return []


add_node(BVTK_NT_PolyDataSilhouette, cat)
...
class BVTK_NT_ImageMapToWindowLevelColors(Node, BVTK_Node):
    ...
    def m_connections(self):
        return ['Input'], ['Output'], ['LookupTable'], ['Self']
    
    def methods(self):
        return []


add_node(BVTK_NT_ImageMapToWindowLevelColors, cat)
...
class BVTK_NT_SphereTreeFilter(Node, BVTK_Node):
    ...
    def m_connections(self):
        return ['Input'], ['Output'], ['SphereTree'], ['Self']
    
    def methods(self):
        return []


add_node(BVTK_NT_SphereTreeFilter, cat)
...
add_node(BVTK_NT_RectilinearGridOutlineFilter, cat)
...
add_node(BVTK_NT_ImageButterworthHighPass, cat)
...
add_node(BVTK_NT_MarchingCubes, cat)
...
add_node(BVTK_NT_NonOverlappingAMRAlgorithm, cat)
...
add_node(BVTK_NT_CollectGraph, cat)
...
add_node(BVTK_NT_MarchingContourFilter, cat)
...
add_node(BVTK_NT_StructuredGridPartitioner, cat)
...
add_node(BVTK_NT_SimpleImageFilterExample, cat)
...
add_node(BVTK_NT_GenericGeometryFilter, cat)
...
add_node(BVTK_NT_UnsignedDistance, cat)
...
class BVTK_NT_GenericCutter(Node, BVTK_Node):
    ...
    def m_connections(self):
        return ['Input'], ['Output'], ['CutFunction'], ['Self']
    
    def methods(self):
        return []


add_node(BVTK_NT_GenericCutter, cat)
...
add_node(BVTK_NT_WeightedTransformFilter, cat)
...
add_node(BVTK_NT_LevelIdScalars, cat)
...
add_node(BVTK_NT_GraphToPoints, cat)
...
add_node(BVTK_NT_TransmitRectilinearGridPiece, cat)
...
add_node(BVTK_NT_ImageRFFT, cat)
...
add_node(BVTK_NT_TemporalShiftScale, cat)
...
add_node(BVTK_NT_AMRCutPlane, cat)
...
add_node(BVTK_NT_ConnectivityFilter, cat)
...
add_node(BVTK_NT_ImageGradientMagnitude, cat)
...
add_node(BVTK_NT_ImageSobel2D, cat)
...
add_node(BVTK_NT_GraphLayoutFilter, cat)
...
add_node(BVTK_NT_HierarchicalDataExtractDataSets, cat)
...
add_node(BVTK_NT_Delaunay3D, cat)
...
add_node(BVTK_NT_TransmitStructuredDataPiece, cat)
...
add_node(BVTK_NT_MultiBlockDataSetAlgorithm, cat)
...
add_node(BVTK_NT_BrownianPoints, cat)
...
add_node(BVTK_NT_HyperTreeGridAxisCut, cat)
...
add_node(BVTK_NT_YoungsMaterialInterface, cat)
...
add_node(BVTK_NT_PLinearExtrusionFilter, cat)
...
class BVTK_NT_GraphToGlyphs(Node, BVTK_Node):
    ...
    def m_connections(self):
        return ['Input'], ['Output'], ['Renderer'], ['Self']
    
    def methods(self):
        return []


add_node(BVTK_NT_GraphToGlyphs, cat)
...
add_node(BVTK_NT_PCAAnalysisFilter, cat)
...
add_node(BVTK_NT_ImageNormalize, cat)
...
add_node(BVTK_NT_TubeFilter, cat)
...
add_node(BVTK_NT_PassThrough, cat)
...
add_node(BVTK_NT_CollectPolyData, cat)
...
add_node(BVTK_NT_ImageToImageStencil, cat)
...
class BVTK_NT_TransformPolyDataFilter(Node, BVTK_Node):
    ...
    def m_connections(self):
        return ['Input'], ['Output'], ['Transform'], ['Self']
    
    def methods(self):
        return []


add_node(BVTK_NT_TransformPolyDataFilter, cat)
...
add_node(BVTK_NT_AngularPeriodicFilter, cat)
...
class BVTK_NT_SampleImplicitFunctionFilter(Node, BVTK_Node):
    ...
    def m_connections(self):
        return ['Input'], ['Output'], ['ImplicitFunction'], ['Self']
    
    def methods(self):
        return []


add_node(BVTK_NT_SampleImplicitFunctionFilter, cat)
...
add_node(BVTK_NT_SplitField, cat)
...
class BVTK_NT_ImageResize(Node, BVTK_Node):
    ...
    def m_connections(self):
        return ['Input'], ['Output'], ['Interpolator'], ['Self']
    
    def methods(self):
        return []


add_node(BVTK_NT_ImageResize, cat)
...
add_node(BVTK_NT_DensifyPointCloudFilter, cat)
...
add_node(BVTK_NT_ImageAppendComponents, cat)
...
add_node(BVTK_NT_PolyDataAlgorithm, cat)
...
add_node(BVTK_NT_QuadraturePointsGenerator, cat)
...
add_node(BVTK_NT_TransposeTable, cat)
...
add_node(BVTK_NT_ComputeQuartiles, cat)
...
add_node(BVTK_NT_MapArrayValues, cat)
...
add_node(BVTK_NT_ProcrustesAlignmentFilter, cat)
...
add_node(BVTK_NT_PProjectSphereFilter, cat)
...
add_node(BVTK_NT_AttributeDataToFieldDataFilter, cat)
...
add_node(BVTK_NT_AdaptiveDataSetSurfaceFilter, cat)
...
add_node(BVTK_NT_WindowedSincPolyDataFilter, cat)
...
add_node(BVTK_NT_VoxelContoursToSurfaceFilter, cat)
...
class BVTK_NT_FlyingEdgesPlaneCutter(Node, BVTK_Node):
    ...
    def m_connections(self):
        return ['Input'], ['Output'], ['Plane'], ['Self']
    
    def methods(self):
        return []


add_node(BVTK_NT_FlyingEdgesPlaneCutter, cat)
...
add_node(BVTK_NT_ExtractUnstructuredGrid, cat)
...
add_node(BVTK_NT_ArcPlotter, cat)
...
class BVTK_NT_ClipConvexPolyData(Node, BVTK_Node):
    ...
    def m_connections(self):
        return ['Input'], ['Output'], ['Planes'], ['Self']
    
    def methods(self):
        return []


add_node(BVTK_NT_ClipConvexPolyData, cat)
...
add_node(BVTK_NT_ImageIslandRemoval2D, cat)
...
add_node(BVTK_NT_AnnotationLayersAlgorithm, cat)
...
add_node(BVTK_NT_ImageQuantizeRGBToIndex, cat)
...
add_node(BVTK_NT_TriangleMeshPointNormals, cat)
...
add_node(BVTK_NT_SplitByCellScalarFilter, cat)
...
add_node(BVTK_NT_QuadratureSchemeDictionaryGenerator, cat)
...
add_node(BVTK_NT_SMPContourGrid, cat)
...
add_node(BVTK_NT_NormalizeMatrixVectors, cat)
...
add_node(BVTK_NT_QuadricClustering, cat)
...
add_node(BVTK_NT_StructuredGridGeometryFilter, cat)
...
add_node(BVTK_NT_ImageSeedConnectivity, cat)
...
add_node(BVTK_NT_UnstructuredGridQuadricDecimation, cat)
...
add_node(BVTK_NT_CleanPolyData, cat)
...
add_node(BVTK_NT_ButterflySubdivisionFilter, cat)
...
add_node(BVTK_NT_ImageThreshold, cat)
...
add_node(BVTK_NT_FillHolesFilter, cat)
...
add_node(BVTK_NT_GradientFilter, cat)
...
add_node(BVTK_NT_PCANormalEstimation, cat)
...
add_node(BVTK_NT_AggregateDataSetFilter, cat)
...
add_node(BVTK_NT_MatrixMathFilter, cat)
...
add_node(BVTK_NT_StrahlerMetric, cat)
...
add_node(BVTK_NT_RectilinearGridToPointSet, cat)
...
add_node(BVTK_NT_SelectionAlgorithm, cat)
...
add_node(BVTK_NT_HyperTreeGridGeometry, cat)
...
add_node(BVTK_NT_HierarchicalBinningFilter, cat)
...
add_node(BVTK_NT_ImageRGBToHSI, cat)
...
add_node(BVTK_NT_ResampleToImage, cat)
...
add_node(BVTK_NT_HierarchicalBoxDataSetAlgorithm, cat)
...
add_node(BVTK_NT_HyperTreeGridToUnstructuredGrid, cat)
...
add_node(BVTK_NT_ExtractGeometry, cat)
...
add_node(BVTK_NT_ImageCast, cat)
...
add_node(BVTK_NT_LinearExtrusionFilter, cat)
...
add_node(BVTK_NT_SynchronizedTemplatesCutter3D, cat)
...
add_node(BVTK_NT_ProjectedTexture, cat)
...
add_node(BVTK_NT_ReverseSense, cat)
...
class BVTK_NT_SpatialRepresentationFilter(Node, BVTK_Node):
    ...
    def m_connections(self):
        return ['Input'], ['Output'], ['SpatialRepresentation'], ['Self']
    
    def methods(self):
        return []


add_node(BVTK_NT_SpatialRepresentationFilter, cat)
...
add_node(BVTK_NT_HyperStreamline, cat)
...
add_node(BVTK_NT_BlockIdScalars, cat)
...
add_node(BVTK_NT_OutlineFilter, cat)
...
add_node(BVTK_NT_ImageGradient, cat)
...
add_node(BVTK_NT_ImageButterworthLowPass, cat)
...
add_node(BVTK_NT_ImageConvolve, cat)
...
add_node(BVTK_NT_PieceScalars, cat)
...
class BVTK_NT_SplineFilter(Node, BVTK_Node):
    ...
    def m_connections(self):
        return ['Input'], ['Output'], ['Spline'], ['Self']
    
    def methods(self):
        return []


add_node(BVTK_NT_SplineFilter, cat)
...
add_node(BVTK_NT_ImageTranslateExtent, cat)
...
add_node(BVTK_NT_ArrayDataAlgorithm, cat)
...
add_node(BVTK_NT_GaussianSplatter, cat)
...
add_node(BVTK_NT_POutlineFilter, cat)
...
add_node(BVTK_NT_TemporalSnapToTimeStep, cat)
...
add_node(BVTK_NT_Threshold, cat)
...
class BVTK_NT_VoxelGrid(Node, BVTK_Node):
    ...
    def m_connections(self):
        return ['Input'], ['Output'], ['Kernel'], ['Self']
    
    def methods(self):
        return []


add_node(BVTK_NT_VoxelGrid, cat)
...
add_node(BVTK_NT_TreeAlgorithm, cat)
...
class BVTK_NT_EvenlySpacedStreamlines2D(Node, BVTK_Node):
    ...
    def m_connections(self):
        return ['Input'], ['Output'], ['Integrator'], ['Self']
    
    def methods(self):
        return []


add_node(BVTK_NT_EvenlySpacedStreamlines2D, cat)
...
add_node(BVTK_NT_HyperTreeGridContour, cat)
...
add_node(BVTK_NT_HyperTreeGridAxisReflection, cat)
...
add_node(BVTK_NT_ImageMapToColors, cat)
...
add_node(BVTK_NT_MultiThreshold, cat)
...
add_node(BVTK_NT_PointDensityFilter, cat)
...
add_node(BVTK_NT_PassInputTypeAlgorithm, cat)
...
add_node(BVTK_NT_DataObjectAlgorithm, cat)
...
add_node(BVTK_NT_ImageMagnitude, cat)
...
add_node(BVTK_NT_BlankStructuredGrid, cat)
...
add_node(BVTK_NT_ImagePadFilter, cat)
...
add_node(BVTK_NT_TextureMapToCylinder, cat)
...
class BVTK_NT_LinearSelector(Node, BVTK_Node):
    ...
    def m_connections(self):
        return ['Input'], ['Output'], ['Points'], ['Self']
    
    def methods(self):
        return []


add_node(BVTK_NT_LinearSelector, cat)
...
add_node(BVTK_NT_DiscreteMarchingCubes, cat)
...
add_node(BVTK_NT_MoleculeToAtomBallFilter, cat)
...
add_node(BVTK_NT_CheckerboardSplatter, cat)
...
add_node(BVTK_NT_DataSetGradient, cat)
...
add_node(BVTK_NT_VertexGlyphFilter, cat)
...
add_node(BVTK_NT_TransmitUnstructuredGridPiece, cat)
...
add_node(BVTK_NT_Curvatures, cat)
...
add_node(BVTK_NT_RecursiveDividingCubes, cat)
...
add_node(BVTK_NT_VoxelModeller, cat)
...
add_node(BVTK_NT_DataObjectToDataSetFilter, cat)
...
add_node(BVTK_NT_GenericContourFilter, cat)
...
add_node(BVTK_NT_ImageYIQToRGB, cat)
...
add_node(BVTK_NT_SynchronizedTemplates2D, cat)
...
add_node(BVTK_NT_CompositeCutter, cat)
...
add_node(BVTK_NT_StructuredGridClip, cat)
...
add_node(BVTK_NT_EdgePoints, cat)
...
add_node(BVTK_NT_SubdivideTetra, cat)
...
add_node(BVTK_NT_ShrinkFilter, cat)
...
add_node(BVTK_NT_DepthSortPolyData, cat)
...
add_node(BVTK_NT_WarpScalar, cat)
...
add_node(BVTK_NT_ImageVariance3D, cat)
...
add_node(BVTK_NT_ImageHSIToRGB, cat)
...
add_node(BVTK_NT_ExtractUnstructuredGridPiece, cat)
...
add_node(BVTK_NT_TemporalInterpolator, cat)
...
add_node(BVTK_NT_ThresholdPoints, cat)
...
add_node(BVTK_NT_PointSetAlgorithm, cat)
...
add_node(BVTK_NT_MaskPolyData, cat)
...
add_node(BVTK_NT_AppendSelection, cat)
...
add_node(BVTK_NT_ImageAnisotropicDiffusion3D, cat)
...
add_node(BVTK_NT_ExtractLevel, cat)
...
add_node(BVTK_NT_ImageMirrorPad, cat)
...
add_node(BVTK_NT_ContourFilter, cat)
...
add_node(BVTK_NT_ReflectionFilter, cat)
...
add_node(BVTK_NT_FlyingEdges3D, cat)
...
add_node(BVTK_NT_SignedDistance, cat)
...
add_node(BVTK_NT_ImageDataToUniformGrid, cat)
...
add_node(BVTK_NT_TableToStructuredGrid, cat)
...
add_node(BVTK_NT_EuclideanClusterExtraction, cat)
...
add_node(BVTK_NT_CollectTable, cat)
...
add_node(BVTK_NT_DataSetGradientPrecompute, cat)
...
add_node(BVTK_NT_HyperTreeGridThreshold, cat)
...
add_node(BVTK_NT_HyperTreeGridCellCenters, cat)
...
add_node(BVTK_NT_ImageRGBToYIQ, cat)
...
add_node(BVTK_NT_UnstructuredGridGeometryFilter, cat)
...
add_node(BVTK_NT_ExtractEdges, cat)
...
add_node(BVTK_NT_ExtractRectilinearGrid, cat)
...
add_node(BVTK_NT_ImageLuminance, cat)
...
add_node(BVTK_NT_ExtractCells, cat)
...
add_node(BVTK_NT_ImageStencilSource, cat)
...
add_node(BVTK_NT_RemoveGhosts, cat)
...
add_node(BVTK_NT_QuadricDecimation, cat)
...
add_node(BVTK_NT_PiecewiseFunctionShiftScale, cat)
...
add_node(BVTK_NT_HyperTreeGridDepthLimiter, cat)
...
add_node(BVTK_NT_LoopSubdivisionFilter, cat)
...
add_node(BVTK_NT_CellCenters, cat)
...
add_node(BVTK_NT_DuplicatePolyData, cat)
...
add_node(BVTK_NT_AssignAttribute, cat)
...
add_node(BVTK_NT_PolyDataConnectivityFilter, cat)
...
add_node(BVTK_NT_ProgrammableFilter, cat)
...
add_node(BVTK_NT_SurfaceReconstructionFilter, cat)
...
add_node(BVTK_NT_ExtractTimeSteps, cat)
...
add_node(BVTK_NT_ImageStencilAlgorithm, cat)
...
add_node(BVTK_NT_AppendPolyData, cat)
...
add_node(BVTK_NT_PReflectionFilter, cat)
...
add_node(BVTK_NT_AppendArcLength, cat)
...
add_node(BVTK_NT_GridSynchronizedTemplates3D, cat)
...
add_node(BVTK_NT_ImageStencilToImage, cat)
...
add_node(BVTK_NT_AMRResampleFilter, cat)
...
add_node(BVTK_NT_DataSetToDataObjectFilter, cat)
...
add_node(BVTK_NT_ExtractPolyDataGeometry, cat)
...
add_node(BVTK_NT_RibbonFilter, cat)
...
class BVTK_NT_VolumeRayCastSpaceLeapingImageFilter(Node, BVTK_Node):
    ...
    def m_connections(self):
        return ['Input'], ['Output'], ['CurrentScalars'], ['Self']
    
    def methods(self):
        return []


add_node(BVTK_NT_VolumeRayCastSpaceLeapingImageFilter, cat)
...
class BVTK_NT_ImageWeightedSum(Node, BVTK_Node):
    ...
    def m_connections(self):
        return ['Input'], ['Output'], ['Weights'], ['Self']
    
    def methods(self):
        return []


add_node(BVTK_NT_ImageWeightedSum, cat)
...
add_node(BVTK_NT_RotationalExtrusionFilter, cat)
...
add_node(BVTK_NT_ThresholdTextureCoords, cat)
...
add_node(BVTK_NT_HierarchicalDataSetGeometryFilter, cat)
...
add_node(BVTK_NT_ImageHybridMedian2D, cat)
...
add_node(BVTK_NT_RectilinearSynchronizedTemplates, cat)
...
class BVTK_NT_ImageDataStreamer(Node, BVTK_Node):
    ...
    def m_connections(self):
        return ['Input'], ['Output'], ['ExtentTranslator'], ['Self']
    
    def methods(self):
        return []


add_node(BVTK_NT_ImageDataStreamer, cat)
...
add_node(BVTK_NT_HyperTreeGridPlaneCutter, cat)
...
add_node(BVTK_NT_ImageShiftScale, cat)
...
add_node(BVTK_NT_ExtractSurface, cat)
...
add_node(BVTK_NT_TriangularTCoords, cat)
...
add_node(BVTK_NT_ImageCityBlockDistance, cat)
...
add_node(BVTK_NT_UndirectedGraphAlgorithm, cat)
...
add_node(BVTK_NT_CellDataToPointData, cat)
...
add_node(BVTK_NT_ImageMapToRGBA, cat)
...
add_node(BVTK_NT_TableAlgorithm, cat)
...
add_node(BVTK_NT_ImageSkeleton2D, cat)
...
add_node(BVTK_NT_PCellDataToPointData, cat)
...
add_node(BVTK_NT_TemporalArrayOperatorFilter, cat)
...
add_node(BVTK_NT_TriangleFilter, cat)
...
add_node(BVTK_NT_UncertaintyTubeFilter, cat)
...
add_node(BVTK_NT_ImageEuclideanDistance, cat)
...
add_node(BVTK_NT_TransformFilter, cat)
...
add_node(BVTK_NT_ExtractDataSets, cat)
...
add_node(BVTK_NT_InterpolateDataSetAttributes, cat)
...
add_node(BVTK_NT_DirectedGraphAlgorithm, cat)
...
add_node(BVTK_NT_PlaneCutter, cat)
...
add_node(BVTK_NT_ImageClip, cat)
...
add_node(BVTK_NT_ImageContinuousDilate3D, cat)
...
add_node(BVTK_NT_ShrinkPolyData, cat)
...
add_node(BVTK_NT_PassThroughFilter, cat)
...
add_node(BVTK_NT_StructuredGridOutlineFilter, cat)
...
add_node(BVTK_NT_ExtractPointCloudPiece, cat)
...
add_node(BVTK_NT_PointDataToCellData, cat)
...
add_node(BVTK_NT_ImageMagnify, cat)
...
add_node(BVTK_NT_GeometryFilter, cat)
...
add_node(BVTK_NT_CellQuality, cat)
...
add_node(BVTK_NT_ImageOpenClose3D, cat)
...
add_node(BVTK_NT_MultiBlockFromTimeSeriesFilter, cat)
...
add_node(BVTK_NT_StructuredGridAlgorithm, cat)
...
add_node(BVTK_NT_PolyDataToReebGraphFilter, cat)
...
class BVTK_NT_ImplicitTextureCoords(Node, BVTK_Node):
    ...
    def m_connections(self):
        return ['Input'], ['Output'], ['RFunction', 'SFunction', 'TFunction'], ['Self']
    
    def methods(self):
        return []


add_node(BVTK_NT_ImplicitTextureCoords, cat)
...
add_node(BVTK_NT_ImageIdealHighPass, cat)
...
add_node(BVTK_NT_ExtractTemporalFieldData, cat)
...
add_node(BVTK_NT_ImageConstantPad, cat)
...
add_node(BVTK_NT_ContourLoopExtraction, cat)
...
add_node(BVTK_NT_MarchingSquares, cat)
...
add_node(BVTK_NT_RectilinearGridPartitioner, cat)
...
add_node(BVTK_NT_ImageHSVToRGB, cat)
...
add_node(BVTK_NT_GreedyTerrainDecimation, cat)
...
add_node(BVTK_NT_ImageBSplineCoefficients, cat)
...
add_node(BVTK_NT_ImageContinuousErode3D, cat)
...
class BVTK_NT_TransformCoordinateSystems(Node, BVTK_Node):
    ...
    def m_connections(self):
        return ['Input'], ['Output'], ['Viewport'], ['Self']
    
    def methods(self):
        return []


add_node(BVTK_NT_TransformCoordinateSystems, cat)
...
add_node(BVTK_NT_MultiBlockDataGroupFilter, cat)
...
add_node(BVTK_NT_GenericDataSetTessellator, cat)
...
add_node(BVTK_NT_TextureMapToSphere, cat)
...
add_node(BVTK_NT_LabelSizeCalculator, cat)
...
add_node(BVTK_NT_IconGlyphFilter, cat)
...
add_node(BVTK_NT_ImageRange3D, cat)
...
add_node(BVTK_NT_ImageCacheFilter, cat)
...
add_node(BVTK_NT_LabelHierarchyAlgorithm, cat)
...
add_node(BVTK_NT_TransmitImageDataPiece, cat)
...
add_node(BVTK_NT_CellSizeFilter, cat)
...
add_node(BVTK_NT_ExtractVOI, cat)
...
add_node(BVTK_NT_LinearToQuadraticCellsFilter, cat)
...
add_node(BVTK_NT_GraphAlgorithm, cat)
...
class BVTK_NT_DijkstraGraphGeodesicPath(Node, BVTK_Node):
    ...
    def m_connections(self):
        return ['Input'], ['Output'], ['RepelVertices'], ['Self']
    
    def methods(self):
        return []


add_node(BVTK_NT_DijkstraGraphGeodesicPath, cat)
...
add_node(BVTK_NT_ExtractGrid, cat)
...
add_node(BVTK_NT_MemoryLimitImageDataStreamer, cat)
...
add_node(BVTK_NT_ImageMarchingCubes, cat)
...
add_node(BVTK_NT_PointConnectivityFilter, cat)
...
add_node(BVTK_NT_ImplicitModeller, cat)
...
add_node(BVTK_NT_RotationFilter, cat)
...
add_node(BVTK_NT_MaskFields, cat)
...
add_node(BVTK_NT_DataSetTriangleFilter, cat)
...
add_node(BVTK_NT_ImageToAMR, cat)
...
add_node(BVTK_NT_FeatureEdges, cat)
...
class BVTK_NT_TessellatorFilter(Node, BVTK_Node):
    ...
    def m_connections(self):
        return ['Input'], ['Output'], ['Subdivider', 'Tessellator'], ['Self']
    
    def methods(self):
        return []


add_node(BVTK_NT_TessellatorFilter, cat)
...
add_node(BVTK_NT_TransformTextureCoords, cat)
...
add_node(BVTK_NT_ContourTriangulator, cat)
...
add_node(BVTK_NT_GraphWeightEuclideanDistanceFilter, cat)
...
add_node(BVTK_NT_TransmitPolyDataPiece, cat)
...
add_node(BVTK_NT_ImageSpatialAlgorithm, cat)
...
add_node(BVTK_NT_ImageToPolyDataFilter, cat)
...
add_node(BVTK_NT_PieceRequestFilter, cat)
...
add_node(BVTK_NT_VolumeOfRevolutionFilter, cat)
...
add_node(BVTK_NT_ExtractBlock, cat)
...
add_node(BVTK_NT_ImageCursor3D, cat)
...
add_node(BVTK_NT_ExtractArray, cat)
...
add_node(BVTK_NT_ImageRGBToHSV, cat)
...
add_node(BVTK_NT_AppendFilter, cat)
...
add_node(BVTK_NT_ImageDilateErode3D, cat)
...
add_node(BVTK_NT_ContourGrid, cat)
...
add_node(BVTK_NT_ElevationFilter, cat)
...
add_node(BVTK_NT_RectilinearGridGeometryFilter, cat)
...
add_node(BVTK_NT_CastToConcrete, cat)
...
add_node(BVTK_NT_ImageEuclideanToPolar, cat)
...
add_node(BVTK_NT_DataSetSurfaceFilter, cat)
...
add_node(BVTK_NT_GenericOutlineFilter, cat)
...
add_node(BVTK_NT_UniformGridGhostDataGenerator, cat)
...
add_node(BVTK_NT_ImageMaskBits, cat)
...
add_node(BVTK_NT_ProjectSphereFilter, cat)
...
add_node(BVTK_NT_RectilinearGridAlgorithm, cat)
...
add_node(BVTK_NT_AppendPoints, cat)
...
add_node(BVTK_NT_TemporalStatistics, cat)
...
add_node(BVTK_NT_DecimatePolylineFilter, cat)
...
class BVTK_NT_ImageSeparableConvolution(Node, BVTK_Node):
    ...
    def m_connections(self):
        return ['Input'], ['Output'], ['XKernel', 'YKernel', 'ZKernel'], ['Self']
    
    def methods(self):
        return []


add_node(BVTK_NT_ImageSeparableConvolution, cat)
...
add_node(BVTK_NT_POutlineCornerFilter, cat)
...
add_node(BVTK_NT_ProgrammableAttributeDataFilter, cat)
...
add_node(BVTK_NT_DecimatePro, cat)
...
add_node(BVTK_NT_RectilinearGridToTetrahedra, cat)
...
add_node(BVTK_NT_OverlappingAMRLevelIdScalars, cat)
...
add_node(BVTK_NT_PolyDataToImageStencil, cat)
...
add_node(BVTK_NT_QuantizePolyDataPoints, cat)
...
add_node(BVTK_NT_TableToPolyData, cat)
...
add_node(BVTK_NT_CutMaterial, cat)
...
add_node(BVTK_NT_ImageWrapPad, cat)
...
add_node(BVTK_NT_RearrangeFields, cat)
...
add_node(BVTK_NT_SimpleElevationFilter, cat)
...
add_node(BVTK_NT_SplitColumnComponents, cat)
...
add_node(BVTK_NT_StructuredGridGhostDataGenerator, cat)
...
add_node(BVTK_NT_TextureMapToPlane, cat)
...
add_node(BVTK_NT_VectorDot, cat)
...
add_node(BVTK_NT_DijkstraImageGeodesicPath, cat)
...
add_node(BVTK_NT_PCACurvatureEstimation, cat)
...
add_node(BVTK_NT_LinearSubdivisionFilter, cat)
...
add_node(BVTK_NT_ExtractPolyDataPiece, cat)
...
add_node(BVTK_NT_ImageMedian3D, cat)
...
add_node(BVTK_NT_PPolyDataNormals, cat)
...
add_node(BVTK_NT_OutlineCornerFilter, cat)
