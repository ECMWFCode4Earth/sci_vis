...
class BVTK_PT_Inspect(bpy.types.Panel):
    ...
    def poll(cls, context):
        return context.active_node is not None and context.space_data.tree_type == 'BVTK_NodeTree'
    ...
    def draw(self, context):
        ...
        layout.operator('bvtk.update_obj', text='Update Object')
        if vtkobj:
            column = layout.column(align=True)
            o = column.operator('bvtk.set_text_editor', text='Documentation')
            o.print = 0
            o = column.operator('bvtk.set_text_editor', text='Node Status')
            o.print = 1
            o = column.operator('bvtk.set_text_editor', text='Output Status')
            o.print = 2
            o = column.operator(
                'bvtk.open_website', text=' Online Documentation', icon='WORLD')
